...
<html>
    ...
    <body>
        ...
        <div class="pendahuluan thumbnail">
            <div class="profile-img-card">
                    <img src="assets/i-his.logo.svg" class="logo-login">
                </div>
            <div class="logo" style="font-size: 32px;">
                    Welcome to <span>e-Appointment</span>
                </div>
            
            <p class="text-center" style="font-size: 18px; line-height: 2em;">e-Appointment is a Web Based application that is used to manage the patient appointment record by using a web based. 
            ...
            <div class="text-center" id="right_column_signinup">
                <button class="btn btn-default btn-lg buttonAuthenticate" onclick="window.location.href = 'login.jsp'">Sign In</button>
                <button class="btn btn-success btn-lg buttonAuthenticate" onclick="window.location.href = 'register.jsp'">Sign Up</button>
            </div>
        </div>
