...
<%
    ...
    Conn conn = new Conn();
    String sqlInsert = "DELETE FROM lhr_ort_neu_press_injury_risk WHERE pmi_no='"+pmino+"' AND hfc_cd = '"+hfc+"' AND episode_date='"+episodeDate+"' AND encounter_date='"+datetime+"' AND discipline_cd='"+my_1_dis_cd+"' AND subdiscipline_cd = '"+my_1_sub_cd+"'";
