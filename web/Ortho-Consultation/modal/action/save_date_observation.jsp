...
<%
    ...
    Conn conn = new Conn();
    String sqlInsert = "INSERT INTO lhr_ort_neu_observation_chart (pmi_no,hfc_cd,episode_date,encounter_date,discipline_cd,subdiscipline_cd) VALUES ('"+pmino+"','"+hfc+"','"+episodeDate+"','"+datetime+"','"+my_1_dis_cd+"','"+my_1_sub_cd+"')";
