...
<tbody>
    ...
    <%
        ...
        if (!hfc.equals("99_iHIS_99") || !last_nine.equals("9")) {
            whereClause = " AND lom.hfc_cd = '" + hfc + "'  ";
        }
