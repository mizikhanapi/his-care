...
<h4>
    SUMMARY OF HEALTH WORKERS WORKLOAD BY DAY
</h4>
    ...
    <form class="form-horizontal" id="addForm">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="reportDailyTotalQuantity" name="reportDailyTotalQuantity" type="text" placeholder="Total Order" class="form-control input-md" maxlength="50" value="<%= formatterInt.format(quantity2)%>" readonly>
                </div>
            </div>
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Daily Summary of Health Workers Workload List</div>\n\
