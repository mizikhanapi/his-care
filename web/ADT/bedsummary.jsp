...
//                String hfc = session.getAttribute("HEALTH_FACILITY_CODE").toString();
            String sqlbedSum2 = "SELECT  a.ward_class_name, b.ward_name,  a.hfc_cd, a.ward_class_code,b.ward_class_code,  b.ward_id, b.discipline_cd "
                    + "FROM wis_ward_class a "
                    + "JOIN wis_ward_name b ON a.ward_class_code = b.ward_class_code AND b.hfc_cd = a.hfc_cd "
                    + "where a.hfc_cd = '" + hfc + "';";
        ...
        <div class="col-md-6 col-lg-4">
            <div class="thumbnail">
                    ...
                    <table class="table table-striped" id="wardBedTable"  width="30%" style="margin-bottom: 0px; margin-top:-30px;">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                String wardDisc = databedSum2.get(i).get(6);

                                String total = "SELECT COUNT(bed_id) FROM wis_bed_id where discipline_cd = '" + wardDisc + "' AND ward_id = '" + wardid + "' and ward_class_code = '" + wardclass + "' ";
                                ...
                                String sqlBedId = "SELECT  bed_id, bed_status from wis_bed_id where discipline_cd = '" + wardDisc + "' AND ward_id = '" + wardid + "' and ward_class_code = '" + wardclass + "'  ";
                ...
                <div style="position: absolute; color: #999; top: 30px; right: 30px; font-weight: 500; text-transform: uppercase">Total Bed: <%= totalNew%></div>
            </div>
        </div>
        <%
            }
