    ...
    <div class="container-fluid">
        <div class="row">
            <%
                ...
                String newnewnewsql = "select e.pmi_no,e.name,e.episode_date,e.episode_time,e.common_queue,q.queue_no,e.doctor,e.status from pms_episode e inner join pms_patient_queue q on q.pmi_no = e.pmi_no where e.status !='1' and e.EPISODE_DATE like '%" + now + "%' and e.HEALTH_FACILITY_CODE='" + hfc + "'";
