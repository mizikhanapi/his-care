...
<%
    ...
    String searchProblem = "SELECT discipline_cd,discipline_name FROM adm_hfc_discipline WHERE hfc_cd = '" + hfc + "' AND  discipline_cd like '%"+key+"%' OR discipline_name like '%"+key+"%'";
