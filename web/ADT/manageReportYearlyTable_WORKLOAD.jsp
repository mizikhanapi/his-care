...
<h4>
    SUMMARY OF HEALTH WORKERS WORKLOAD BY YEAR
</h4>
 ...
 <%
        ...
        for (int i = 0; i < size; i++) {
         ...
         //   quantity3 = quantity3 + Double.parseDouble(dataReportDaily.get(i).get(2));
            ...
            String sql1 = " SELECT YEAR(pms_patient_queue.episode_date) AS DATE,"
                    + "COUNT(pms_patient_queue.pmi_no),"
                    + "COUNT(pms_patient_queue.pmi_no),"
                    + "YEAR(pms_patient_queue.created_date),  pms_patient_queue.user_id, adm_users.USER_NAME, pms_patient_queue.pmi_no "
    ...
    <form class="form-horizontal" id="addForm">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="reportYearlyTotalQuantity" name="reportYearlyTotalQuantity" type="text" placeholder="Total Order" class="form-control input-md" maxlength="50" value="<%= formatterInt.format(quantity2)%>" readonly>
                </div>
            </div>
            ...
            buttons: [
                {
                    ...
                    title: 'Yearly Summary of Health Workers Workload List',
                    ...
                    extend: 'print',
                    text: 'Print Yearly Summary of Health Workers Workload List',
                    title: $('h1').text(),
                    message: '<br><br>',
                    className: 'btn btn-primary',
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Yearly Summary of Health Workers Workload List</div>\n\
