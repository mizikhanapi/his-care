...
<tbody>
    ...
    <%
        ...
        String sql = " SELECT YEAR(wis_inpatient_episode.created_date) AS DATE,"
                + "COUNT(wis_inpatient_episode.pmi_no),"
                + "COUNT(wis_inpatient_episode.pmi_no),"
                + "YEAR(wis_inpatient_episode.created_date)  "
            ...
            buttons: [
                {
                    ...
                    title: 'Inpatient Yearly Admission List',
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Yearly Inpatient Admission List</div>\n\
