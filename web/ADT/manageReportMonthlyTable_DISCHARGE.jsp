...
<tbody>
    ...
    <%        NumberFormat formatterInt = new DecimalFormat("#0");
     ...
     String sql = " SELECT DATE_FORMAT(wis_inpatient_episode_history.episode_date, '%M %Y') AS DATE, "
                ...
                + "COUNT(wis_inpatient_episode_history.pmi_no),"
                + "EXTRACT(YEAR_MONTH FROM wis_inpatient_episode_history.created_date) "
            ...
            buttons: [
                {
                    ...
                    title: 'Inpatient Monthly Discharge List',
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Monthly Inpatient Discharge List</div>\n\
