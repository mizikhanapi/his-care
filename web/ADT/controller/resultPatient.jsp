    ...
    if (status.equals("1")) {
        ...
        if (idType.equals("pmino") || idType.equals("001")) {
            searchPatient = "select a.pmi_no,a.pmi_no_temp,a.patient_name,a.title_code,a.new_ic_no,a.old_ic_no,a.id_type,a.id_no,a.eligibility_category_code,a.eligibility_type_code,"
                    ...
                    + " left join adm_lookup_detail b on b.detail_reference_code=a.home_district_code and b.master_reference_code='0078' AND b.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail c on c.detail_reference_code=a.home_town_code and c.master_reference_code='0003' AND c.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail d on d.detail_reference_code=a.home_postcode and d.master_reference_code='0079' AND d.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail e on e.detail_reference_code=a.home_state_code and e.master_reference_code='0002' AND e.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail f on f.detail_reference_code=a.home_country_code and f.master_reference_code='0001' AND f.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail g on g.detail_reference_code=a.postal_district_code and g.master_reference_code='0078' AND g.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail h on h.detail_reference_code=a.postal_town_code and h.master_reference_code='0003' AND h.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail i on i.detail_reference_code=a.postal_postcode and i.master_reference_code='0079' AND i.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail j on j.detail_reference_code=a.postal_state_code and j.master_reference_code='0002' AND j.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail k on k.detail_reference_code=a.postal_country_code and k.master_reference_code='0001' AND k.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail l on l.detail_reference_code=a.title_code and l.master_reference_code='0026' AND l.hfc_cd = '"+hfc+"'"
                    + " left join adm_lookup_detail m on m.detail_reference_code=a.nationality and m.master_reference_code='0011' AND m.hfc_cd = '"+hfc+"'"
