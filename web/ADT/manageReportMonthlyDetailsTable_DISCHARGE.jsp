...
<tbody>
    ...
    <%
        ...
        String sql = " SELECT DATE_FORMAT(wis_inpatient_episode_history.episode_date, '%M %Y') AS DATE, "
                ...
                + " WHERE wis_inpatient_episode.hfc_cd  = '" + hfc + "' AND EXTRACT(YEAR_MONTH FROM wis_inpatient_episode_history.episode_date) = '" + date + "' AND wis_inpatient_episode_history.inpatient_status  = '2'  AND adm_lookup_detail.master_reference_code = '0063' group by wis_inpatient_episode_history.pmi_no   ";
        ...
        //    quantity = quantity + Double.parseDouble(dataReportMonthly.get(i).get(3));
