...
<tbody>
    ...
    <%
        ...
        String sql = " SELECT YEAR(wis_inpatient_episode.episode_date) AS DATE, "
                ...
                + " WHERE wis_inpatient_episode.hfc_cd  = '" + hfc + "'  AND adm_lookup_detail.master_reference_code = '0063' AND YEAR(wis_inpatient_episode.created_date) = '" + date + "'group by  wis_inpatient_episode.pmi_no ";
